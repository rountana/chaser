...
export const MOCK_RESULTS: RustSearchResult[] = [
  {
    filePath: '/Users/demo/outputs/online/text/vacation-notes.md',
    ...
    pageNum: null, backend: 'keyword', score: 0.82, extractionMode: 'online',
    meta: { person: null, docType: 'note', date: '2025-08', pages: null, words: 420, keyword: 'dog' },
  },
  {
    filePath: '/Users/demo/outputs/online/text/milo-vet-records.md',
    ...
    pageNum: 1, backend: 'keyword', score: 0.71, extractionMode: 'online',
    meta: { person: null, docType: 'medical', date: '2025-03', pages: 3, words: 840, keyword: 'dog' },
  },
  {
    filePath: '/Users/demo/outputs/offline/text/summer-2025-blog-draft.md',
    ...
    pageNum: null, backend: 'keyword', score: 0.61, extractionMode: 'offline',
    meta: { person: null, docType: null, date: '2025-08', pages: null, words: 1820, keyword: 'dog' },
  },
  {
    filePath: '/Users/demo/outputs/offline/text/packing-list.md',
    ...
    pageNum: null, backend: 'keyword', score: 0.41, extractionMode: 'offline',
